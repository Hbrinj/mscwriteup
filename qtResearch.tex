...
%
\ssctn{GTK}
\fig{\centering\img{0.5}{research/gimp}}{GIMP image editor built using GTK}{gtkgimp}
...
\ssctn{QT}
\fig{\centering\img{0.35}{research/amd}}{AMD graphics manager built using QT}{qtamd}
...
\fig{\centering\img{0.23}{research/atom}}{Atom, a popular text editor built using Electron}{electronatom}
