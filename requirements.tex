...
\begin{tikzpicture}[>=latex]
  ...
  Prototyping is a key component of the Agile methodology, to do so two individual requirement specifications will be developed, one for the prototype and one for the final product. It is important to develop prototypes as they can quickly reveal issues with implementation considerations.
  %
  \sssctn{Prototype}
  ...
  \sssctn{Final product}
    ...
    \item Introduce no additional dependencies
		...
		\item Watch points integrated into advanced view
